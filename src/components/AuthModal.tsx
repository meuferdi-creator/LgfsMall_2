...
import { ArrowRight, User as UserIcon, XCircle, CheckCircle2, Lock, ShoppingBag, ShieldCheck, Sparkles } from "lucide-react";
        ...
        {authMode === "login" ? (
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-white dark:bg-emerald-900 text-slate-800 dark:text-white border border-slate-200 dark:border-emerald-700 font-bold py-2.5 px-4 rounded-xl flex items-center justify-center space-x-2 text-xs transition-all hover:bg-slate-50 cursor-pointer shadow-xs"
            >
